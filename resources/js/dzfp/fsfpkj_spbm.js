var dzfp_fsfpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "026", true, zsfs);
            //切换行
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "026", true, blxx, "", zsfs);
        },
        //打开费用项目dlg
        ...
        openFskjDlg: function () {
            var _this = this;
            $.pdialog.open(ctxPath + "/dzfp_fs_spbm/fskjDlg.do", "dzfp_fskjDlg_dlg", "销项负数发票代码号码填写、确认", {
                width: 480,
                height: 245,
                callback: function () {
                    $("#dlg_next_bt").click(function () {
                        ...
                        ajaxLoad(ctxPath + "/dzfp_fs_spbm/searchYfp.do", {
                            yfpdm: yfpdm,
                            yfphm: yfphm,
                            tspz: tspz
                        }, function (json) {
        ...
        addExtraInfo: function () {
            ...
            _$("#dzfp_fsfpkj_spbm_form").append(extraDiv);
        ...
        printfp: function () {
            ...
            dzfp_fsfpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            dzfp_fsfpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/dzfp_fs_spbm/check.do?tspz=" + tspz, {async: false}, function (json) {
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#dzfp_fsfpkj_spbm_form").submit();
                    });
                }
            });
            //差额征税
