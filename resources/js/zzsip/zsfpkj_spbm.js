var zzsjp_fpkj_spbm = function () {
    var maxRowIndex, nowRowIndex, maxZkRow, jplxhs, jplx;
    var qdbz;
    var w1, w2, w5, w6, w7, w8, w9;
    var hsbz;
    ...
    return {
        ...
        spxx: function () {
            ...
            tspz = "00";
            splxxx.spxx(index, hsbz, "025", false, blxx, jplx);
        },
        //打开费用项目dlg
        ...
        addZk: function () {
            ...
            $.pdialog.open(ctxPath + "/zzsjp_spbm/addZk.do", "zzsjp_addZk_dlg", "添加折扣", {
                width: 450,
                height: 240,
                callback: function () {
                    $("#zkhs").empty();
        ...
        validateZsfp: function () {
            ...
            // if (jplx == "07") {
            //     if ((maxRowIndex + maxZkRow == jplxhs) && bzlength > 0) {
            //         alert("当前版式发票输入备注时明细项目最多行数为17行！");
            //         return false;
            //     }
            // }
            // if (jplx == "06") {
            //     if ((maxRowIndex + maxZkRow == jplxhs) && bzlength > 0) {
            //         alert("当前版式发票输入备注时明细项目最多行数为20行！");
            //         return false;
            //     }
            // }
            var enterNum = 0;
        ...
        addExtraInfo: function () {
            ...
            _$("#zzsjp_fpkj_spbm_form").append(extraDiv);
        ...
        fyxmdr: function (json) {
            dialogAjaxDone(json);
            if (json.fyxm) {
                zzsjp_fpkj_spbm.setValueFromExcel(json.fyxm);
            } else {
                alert("没有找到符合条件的数据！");
...
//		},
        ...
        printfp: function () {
            ...
            zzsjp_fpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            zzsjp_fpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/zzsjp_spbm/check.do", {async: false}, function (json) {
                ...
                if (fpmx) {
                    ...
                    for (var i = 0; i < mxzb.length; i++) {
                        ...
                        if (mxzb[i].fphxz == "2") {
                            ...
                            _$("#spdj_" + index).val(mxzb[i].hsdj);
                            _$("#je_" + index).val(mxzb[i].hsje);
