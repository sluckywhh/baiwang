var cpy_dzfp_fpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "026", false, zsfs,true);
            //切换行
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "026", false, blxx, "", zsfs, true);
        },
        //打开费用项目dlg
        ...
        addZk: function () {
            ...
            $.pdialog.open(ctxPath + "/cpy_zpp_zsfpkj/addZk.do", "dzfp_addZk_dlg", "添加折扣", {
                width: 450,
                height: 240,
                callback: function () {
                    $("#zkhs").empty();
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_dzfp_fpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_dzfp_fpkj_spbm_form");
        ...
        kjcg: function (json) {
            ...
            if (json.statusCode == DWZ.statusCode.ok) {
                ...
                disableButtons(_$("#xz,#sc,#zk,#jg,#qd,#kj,#dkp"));
        ...
        initbjFromCookie: function () {
            ...
            $.pdialog.open(ctxPath + "/zzp/tzbj.do", "zzspp_tzbj_dlg", "调整边距", {
                ...
                callback: function () {
                    ...
                    var zbj = $.cookie("zbj_dzfp");
                    if (!zbj) {
                        zbj = defaultZbj;
                    }
                    var ybj = $.cookie("ybj_dzfp");
                    if (!ybj) {
                        ybj = defaultYbj;
                    }
                    $("#zbj").val(zbj);
        ...
        printfp: function () {
            ...
            cpy_dzfp_fpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_dzfp_fpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_dzfp_zsfpkj/check.do", {async: false}, function (json) {
                enableButtons(_$("#xz,#jg,#qd,#kj,#dkp"));
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#cpy_dzfp_fpkj_spbm_form").submit();
                    });
                }
            });
            //预览
