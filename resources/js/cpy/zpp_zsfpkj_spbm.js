var cpy_zzspp_fpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "007", false, zsfs,true);
            //切换行
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "007", false, blxx, "", zsfs, true);
        },
        //打开费用项目dlg
        ...
        newLine: function (index) {
            return "<tr><td id='row_"
                ...
                + "' name='ggxh_" + index
                + "' maxlength='40' style='width:72px;'/></td><td style='width:" + w4 + "px;border-right:1px solid green;'>"
        ...
        addZk: function () {
            ...
            $.pdialog.open(ctxPath + "/cpy_zpp_zsfpkj/addZk.do", "zzspp_addZk_dlg", "添加折扣", {
                width: 450,
                height: 240,
                callback: function () {
                    $("#zkhs").empty();
        ...
        validateZsfp: function () {
            ...
            if (tspz == "02") {
                ...
                if (ghdwdm.value != "" && (ghdwdm.value).length != 9 && !regex.test(ghdwdm.value)) {
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_zzspp_fpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_zzspp_fpkj_spbm_form");
        ...
        fyxmdr: function (json) {
            dialogAjaxDone(json);
            if (json.fyxm) {
                cpy_zzspp_fpkj_spbm.setValueFromExcel(json.fyxm);
            } else {
                alert("没有找到符合条件的数据！");
        ...
        printfp: function () {
            ...
            cpy_zzspp_fpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_zzspp_fpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_zpp_zsfpkj/check.do?tspz=" + tspz, {async: false}, function (json) {
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#cpy_zzspp_fpkj_spbm_form").submit();
                    });
                }
            });
            //费用明细导入
