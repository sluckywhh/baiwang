var cpy_zzspp_fsfpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "007", true, zsfs,true);
            //切换行
                    ...
                    if (!yfpIsMulti) {// 单税率
                        ...
                        if (se != "" && se != null && se != 0) {
                            ...
                            if (ce >= 0) {
                                ...
                                _$("#je_1").val("");
                                cpy_zzspp_fsfpkj_spbm.reCountHjje();
                                return;
                            }
                        }
                    }
            ...
            //吨和升的切换监听
            newLine.find("select[id^='dw']").bind("change", function () {
                var index = getIndex(this.id);
                var dj = _$("#spdj_" + index).val();
                var value = $(this).val();
                var bm = _$("#spbm_" + index).val();
                var sl = _$("#spsl_" + index).val();
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "007", true, blxx, "", zsfs,true);
        },
        //打开费用项目dlg
        openFyxmDlg: function () {
            var url = ctxPath + "/cpy_zpp_fsfpkj/selFyxm.do?targetType=dialog&index=";
        ...
        newLine: function (index) {
            return "<tr><td id='row_"
                ...
                + "' name='ggxh_" + index
                + "' maxlength='36' style='width:72px;'/></td><td style='width:" + w4 + "px;border-right:1px solid green;'>"
                +"<select id='dw_" + index + "' name='dw_" + index + "' style='width:40px'> <option value='升'>升</option> <option value='吨'>吨</option> </select>"
                + "</td><td style='width:" + w5 + "px;border-right:1px solid green;'><input id='spsl_"
        ...
        reCountRow: function (index) {
            ...
            if (zsfs == "2" && _$("#hsxseBz").val() != "" && _$("#kceBz").val() != "") {
                var hsxse = _$("#hsxseBz").val() * 1;
                var kce = _$("#kceBz").val() * 1;
                var sl = _$("#sl_1").val() * 1;
        ...
        addZk: function () {
            ...
            $.pdialog.open(ctxPath + "/cpy_zpp_fsfpkj/addZk.do", "zzspp_addZk_dlg", "添加折扣", {
                width: 450,
                height: 240,
                callback: function () {
                    $("#zkhs").empty();
        ...
        openFskjDlg: function () {
            var _this = this;
            $.pdialog.open(ctxPath + "/cpy_zpp_fsfpkj/fskjDlg.do", "zzspp_fskjDlg_dlg", "销项负数发票代码号码填写、确认", {
                width: 480,
                height: 245,
                callback: function () {
                    $("#dlg_next_bt").click(function () {
                        ...
                        ajaxLoad(ctxPath + "/cpy_zpp_fsfpkj/searchYfp.do", {
                            yfpdm: yfpdm,
                            yfphm: yfphm,
                            tspz: tspz
                        }, function (json) {
        ...
        jyxxb: function () {
            ...
            //校验输入
            if (!/\d{10}/.test(yfpdm) || /^0+$/.test(yfpdm) || (yfpdm.length == 11)) {
                alert("销项正数发票代码填写有误！");
                return false;
            ...
            if (sfyyfp == true) {
                ...
                for (var i = 1; i <= mxzb.length; i++) {
                    ...
                    if (zsfs == 1) {
                        ...
                        _$("#spdj_" + i).val(mxzb[i - 1].spsl ? delRight((-(_$("#je_" + i).val() * 1) / (mxzb[i - 1].spsl * 1)).toFixed(6)) : "");
                    } else {
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_zzspp_fsfpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_zzspp_fsfpkj_spbm_form");
        ...
        kjcg: function (json) {
            ...
            if (json.statusCode == DWZ.statusCode.ok) {
                ...
                disableButtons(_$("#xz,#sc,#jg,#kj,#fs,#cezs,#jazs"));
        ...
        printfp: function () {
            ...
            cpy_zzspp_fsfpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_zzspp_fsfpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_zpp_fsfpkj/check.do?tspz=" + tspz, {async: false}, function (json) {
                enableButtons(_$("#xz,#jg,#fs,#cezs,#jazs"));
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#cpy_zzspp_fsfpkj_spbm_form").submit();
                    });
                }
            });
            //差额征税
