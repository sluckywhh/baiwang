var cpy_zzp_fpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "004", fskj, zsfs,true);
            //切换行
            ...
            newLine.find("select[id^='dw']").bind("change", function () {
                ...
                var optDj=_$("#spsl_"+index).attr("optDj");
                var optSpsl=_$("#spsl_"+index).attr("optSpsl");
                if (bm && dj) {
                    if(optDj){
                        var temp=dj;
                        dj=optDj;
                ...
                _$("#spdj_" + index).attr("optDj",optDj);
                _$("#spsl_" + index).val(sl);
                _$("#spsl_" + index).attr("optSpsl",optSpsl);
                _this.reCountRow(index);
            });
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "004", fskj, blxx, "", zsfs, "y");
        },
        //打开费用项目dlg
        ...
        newLine: function (index) {
            return "<tr><td id='row_"
                ...
                + "' name='ggxh_" + index
                + "' maxlength='36' style='width:72px;'/></td>"
                + "<td style='width:" + w4 + "px;border-right:1px solid green;'>"

                + "<select id='dw_" + index + "' name='dw_" + index + "' style='width:40px'> <option value='升'>升</option> <option value='吨'>吨</option> </select>"
                //+"<input id='dw_" + index + "' name='dw_" + index + "' maxlength='14' style='width:40px;'/>"
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_zzp_fpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_zzp_fpkj_spbm_form");
        ...
        openFskjDlg: function () {
            var _this = this;
            $.pdialog.open(ctxPath + "/cpy_zzp/fskjDlg.do", "zzp_fskjDlg_dlg", "导入开具请上传信息表文件", {
                width: 500,
                height: 200,
                callback: function () {
                    $("#dlg_next_bt").click(function () {
                        ...
                        ajaxLoad(ctxPath + "/cpy_zzp/xybjy.do", {
                            xxbbh: xxbbh,
                            yfpdm: yfpdm,
                            yfphm: yfphm
                        }, function (json) {
        ...
        hzxxbht: function (json) {
            ...
            if (json.hzfpmx) {
                ...
                cpy_zzp_fpkj_spbm.setValueFromYfp(json.hzfpmx);
            }
        },
        //校验信息表
        jyxxb: function () {
        ...
        setValueFromYfp: function (yfp) {
            ...
            for (var i = 1; i <= mxzb.length; i++) {
                ...
                if (sl == "") {
                    ...
                    if (this.szsmStr.indexOf(sl2) < 0) {
                        this.szsmStr += ("<option value='" + sl2 + "'>" + sl2 * 100 + "%</option>");
                    }
        ...
        cxgfxx: function () {
            var _this = this;
            $.pdialog.open(ctxPath + "/cpy_zzp/gfxxDlg.do", "zzp_cxgfxx_dlg", "查询购方信息", {
                width: 600,
                height: 215,
                callback: function () {
                    $("#dlg_next_bt").click(function () {
        ...
        fyxmdr: function (json) {
            dialogAjaxDone(json);
            if (json.fyxm) {
                cpy_zzp_fpkj_spbm.setValueFromExcel(json.fyxm);
            } else {
                alert("没有找到符合条件的数据！");
        ...
        printfp: function () {
            ...
            cpy_zzp_fpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_zzp_fpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_zzp/check.do", {async: false}, function (json) {
            ...
            _$("#kj").click(function () {
                ...
                var $form = _$("#cpy_zzp_fpkj_spbm_form").serialize();
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#cpy_zzp_fpkj_spbm_form").submit();
                    });
                }
            });
            //负数
