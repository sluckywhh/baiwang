var cpy_jsfp_fsfpkj_spbm = function () {
    ...
    return {
        ...
        spxx: function () {
            ...
            tspz = "00";
            splxxx.spxx(index, hsbz, "025", true, blxx, jplx, "0", true);
        },
        //打开费用项目dlg
        ...
        addZk: function () {
            ...
            $.pdialog.open(ctxPath + "/cpy_jsfp_fsfpkj/addZk.do", "jsfp_addZk_dlg", "添加折扣", {
                width: 450,
                height: 240,
                callback: function () {
                    $("#zkhs").empty();
        ...
        openFskjDlg: function () {
            var _this = this;
            $.pdialog.open(ctxPath + "/cpy_jsfp_fsfpkj/fskjDlg.do", "jsfp_fskjDlg_dlg", "销项负数发票代码号码填写、确认", {
                width: 480,
                height: 245,
                callback: function () {
                    $("#dlg_next_bt").click(function () {
                        ...
                        ajaxLoad(ctxPath + "/cpy_jsfp_fsfpkj/searchYfp.do", {
                            yfpdm: yfpdm,
                            yfphm: yfphm
                        }, function (json) {
                            if (json.errMessage) {
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_jsfp_fsfpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_jsfp_fsfpkj_spbm_form");
        ...
        printfp: function () {
            ...
            cpy_jsfp_fsfpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_jsfp_fsfpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_jsfp_fsfpkj/check.do", {async: false}, function (json) {
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#fppy").val(jplx);
                        _$("#cpy_jsfp_fsfpkj_spbm_form").submit();
                    });
                }
            });
            //预览
