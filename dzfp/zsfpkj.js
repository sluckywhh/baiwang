var dzfp_fpkj = function(){
	...
	return {
		...
		addExtraInfo:function (){
			...
			_$("#dzfp_fpkj_form").append(extraDiv);
		...
		kjcg:function(json){
			...
			if (json.statusCode == DWZ.statusCode.ok){
				disableButtons(_$("#xz,#sc,#zk,#jg,#qd,#kj"));
		...
		printfp:function (){
			...
			dzfp_fpkj.initPrintData();
			$.cookie("dyfs")=="1"?LODOP.PRINTA():LODOP.PRINT();
		},
		initYLData:function (){
			dzfp_fpkj.initPrintData(true);
		...
		initPage:function(){
			...
			ajaxLoad(ctxPath+"/dzfp/check.do",{async:false},function(json){
				enableButtons(_$("#xz,#jg,#qd,#kj"));
