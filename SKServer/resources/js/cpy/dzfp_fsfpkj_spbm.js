var cpy_dzfp_fsfpkj_spbm = function () {
    ...
    return {
        ...
        addRow: function (p) {
            ...
            quicklyChoiceSpbm(newLine, hsbz, "026", true, zsfs,true);
            //切换行
        ...
        spxx: function () {
            ...
            splxxx.spxx(index, hsbz, "026", true, blxx, "", zsfs,true);
        },
        //打开费用项目dlg
        openFyxmDlg: function () {
            var url = ctxPath + "/cpy_dzfp_fsfpkj/selFyxm.do?targetType=dialog&index=";
            ...
            $.pdialog.open(ctxPath + "/cpy_zpp_fsfpkj/fskjDlg.do", "zzspp_fskjDlg_dlg", "销项负数发票代码号码填写、确认", {
                ...
                callback: function () {
                    $("#dlg_next_bt").click(function () {
                        ...
                        ajaxLoad(ctxPath + "/cpy_dzfp_fsfpkj/searchYfp.do", {
                            yfpdm: yfpdm,
                            yfphm: yfphm,
                            tspz: tspz
                        }, function (json) {
        ...
        setValueFromYfp: function (yfp, sfyyfp) {
            ...
            if (sfyyfp == true) {
                ...
                _$("#fhr").val(yfp.fhr);
                _$("#kpr").val(yfp.kpr);
                _$("#gfkhdh").val(yfp.gfkhdh);
                _$("#gfkhyx").val(yfp.gfkhyx);
                _$("#dzdh").val(yfp.dzdh);
        ...
        addExtraInfo: function () {
            ...
            _$("#cpy_dzfp_fsfpkj_spbm_form").append(extraDiv);
            ...
            var cpy_form=_$("#cpy_dzfp_fsfpkj_spbm_form");
        ...
        printfp: function () {
            ...
            cpy_dzfp_fsfpkj_spbm.initPrintData();
            $.cookie("dyfs") == "1" ? LODOP.PRINTA() : LODOP.PRINT();
        },
        initYLData: function () {
            cpy_dzfp_fsfpkj_spbm.initPrintData(true);
        ...
        initPage: function () {
            ...
            ajaxLoad(ctxPath + "/cpy_dzfp_fsfpkj/check.do", {async: false}, function (json) {
            ...
            _$("#kj").click(function () {
                ...
                if (valid) {
                    ...
                    checkPerm(function () {
                        _this.addExtraInfo();
                        _$("#cpy_dzfp_fsfpkj_spbm_form").submit();
                    });
                }
            });
            //预览
