...
var fpsbprintKpy=function(){
    var nsrshh,qyname,dzdh,datedy,fpqdtjModels;
    return {	
    	initDcPage : function() {
    		
    		if( _$("#cxdyKpy_fplxdm").val()==""){
    		...
    		if(_$("#pnid").val()=="" || _$("#pnid").val()=="-1"){
				alertMsg.warn("请选择查询选项");
				$.pdialog.closeCurrent();
				return;
			}
    		var fplxdm = _$("#cxdyKpy_fplxdm").val();
    		var smonth = _$("#xzsmonthid").val();
    		var pn = _$("#pnid").val();
    		var fileName;
        	if(_$("#pnid").val()=='1'){
        		fileName="发票汇总表";
    		...
    		$("#cxdcfpzlid").val(fplxdm);
    		$("#cxdcsmonthid").val(smonth);
    		$("#cxdcpnid").val(fileName);
    		$("#cxdcpnhiddenid").val(pn);
			$("#djdcf_excel").click(function() {
				$("#djdc_form").submit();
				$.pdialog.closeCurrent();
			});
	},
        ...
        initPrintData:function(yl,dylx){
            ...
            if (dylx == 1) {
                ...
                LODOP.ADD_PRINT_TEXT(151,82,126,20,tablename+"统计表：");
               ...
               // LODOP.ADD_PRINT_TEXT(297,167,85,20,$("#qckcfs").text());
                //LODOP.SET_PRINT_STYLEA(0,"PreviewOnly",1);
                //LODOP.ADD_PRINT_TEXT(317,167,85,20,$("#gjfpfs").text());
                //LODOP.ADD_PRINT_TEXT(337,167,85,20,$("#thfpfs").text());
                LODOP.ADD_PRINT_TEXT(297,82,85,20,"正数发票份数");
                LODOP.ADD_PRINT_TEXT(317,82,85,20,"正数废票份数");
              //  LODOP.ADD_PRINT_TEXT(337,252,85,20,"期末库存份数");
                LODOP.ADD_PRINT_TEXT(297,180,85,20,_$("#zsfpfs").text());
                LODOP.ADD_PRINT_TEXT(317,180,85,20,_$("#zffpfs").text());
               // LODOP.ADD_PRINT_TEXT(337,337,85,20,$("#qmkcfs").text());
                LODOP.ADD_PRINT_TEXT(297,280,85,20,"负数发票份数");
                LODOP.ADD_PRINT_TEXT(317,280,85,20,"负数废票份数");
                LODOP.ADD_PRINT_TEXT(297,380,85,20,_$("#fsfpfs").text());
                LODOP.ADD_PRINT_TEXT(317,380,85,20,_$("#fffpfs").text());
                LODOP.ADD_PRINT_TEXT(337,82,85,20,"空废发票份数");
                LODOP.ADD_PRINT_TEXT(337,180,85,20,_$("#kffpfs").text());
                ...
                //宽210.1mm高297.1mm
                LODOP.PRINT_INITA("1.3mm", "-2.6mm", "210.1mm", "297.1mm",tablename+"明细表");
                ...
                LODOP.SET_PRINT_STYLEA(0,"ItemType",1);
                LODOP.ADD_PRINT_TEXT(104, 23, 126, 20, tablename+"统计表：");
                LODOP.SET_PRINT_STYLEA(0,"ItemType",1);
        ...
        exportExcel:function(){
        	...
        	if(_$("#pnid").val()=='1'){
        		var curTbl = document.getElementById("fptj_id");
        		...
        		if(fplxdm=='025'){
        			op = {
                        form:_$('form[rel]'),
                        fileName:fileName,
                        param:[{name:"header",value:"发票种类@类别代码@发票号码@开票日期@购方税号@合计金额@合计税额"},
                        {name:"headerAtt",value:"0@1@2@3@4@5@6"}]
                    };
        		}else{
        			op = {
                            form:_$('form[rel]'),
                            fileName:fileName,
                            param:[{name:"header",value:"发票种类@类别代码@发票号码@开票日期@购方税号@合计金额@合计税额@税率"},
                            {name:"headerAtt",value:"0@1@2@3@4@5@6@7"}]
                        };
        		}
                exportExcel(op)
        	}
